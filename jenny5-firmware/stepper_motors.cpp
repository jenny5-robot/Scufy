...
//-------------------------------------------------------------------------------
void t_stepper_motors_controller::run_motors(t_potentiometers_controller *potentiometers_control, t_buttons_controller *buttons_controller, char* serial_out)
{
  serial_out[0] = 0;
  // run motors
  ...
  {
    int dist_to_go;
    byte result = motors[m].run_motor(potentiometers_control, buttons_controller, dist_to_go);
...
//-------------------------------------------------------------------------------
void t_stepper_motors_controller::go_home(byte motor_index, t_potentiometers_controller *potentiometers_control, t_buttons_controller *buttons_controller)
{
  motors[motor_index].go_home(potentiometers_control, buttons_controller);
}
//-------------------------------------------------------------------------------
